    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 9, 5, 20, 44, 32, 314, DateTimeKind.Utc).AddTicks(830), "admin@exchangesystem.com", "Администратор системы", true, new DateTime(2025, 9, 5, 20, 44, 32, 314, DateTimeKind.Utc).AddTicks(830), "$2a$11$SWL1sbN2PR60DND5RiuNbePvjAVv9yMo8kmSpFZzMdUvEZMEDjJZC", "Admin", "admin" });
